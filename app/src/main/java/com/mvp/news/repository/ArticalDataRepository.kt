 ...
 */
class ArticalDataRepository @Inject constructor(val api: API) : ArticalRepository {

    override fun getArticalCategory() = arrayListOf(Category("Android"), Category("iOS"), Category("休息视频"))
