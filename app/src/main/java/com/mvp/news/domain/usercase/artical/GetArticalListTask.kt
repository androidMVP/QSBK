 ...
 */
class GetArticalListTask @Inject constructor(val articalRepository: ArticalRepository, postExecutionThread: PostExecutionThread) : UseCase<Artist, GetArticalListTask.Params>(postExecutionThread) {
